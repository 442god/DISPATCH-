...
- If your endpoint is on `superdispatch.com`, extension ignores `apiToken` to avoid browser-session token side effects; use your own backend endpoint for Bearer-token auth.
